...
# how many degrees are rotate by, please use 45 or 135 according to subject
rotation_degree=((-20/180.)*np.pi,(25/180.)*np.pi)
...
target_order=['random',get_targets((0,2,5,3,1,4,5,6)),get_targets((6,7,4,1,0,3,2,5)), get_targets(((7,1,4,2,0,3,4,5))), get_targets((5,6,3,0,7,2,1,4))]
